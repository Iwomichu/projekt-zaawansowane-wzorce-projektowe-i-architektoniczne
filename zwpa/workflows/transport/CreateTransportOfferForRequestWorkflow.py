...
from zwpa.model import TransportOffer, TransportOfferStatus, TransportRequest, UserRole
...
class CreateTransportOfferForRequestWorkflow:
    ...
    def create_transport_offer_for_request(
        ...
        with self.session_maker() as session:
            ...
            transport_offer = TransportOffer(
                ...
                transport_id=transport_request.transport_id,
